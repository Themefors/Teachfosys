                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div className="relative w-full lg:w-1/2 flex items-center justify-center">
                        ...
                        <div ref={(el) => (cardsRef.current[0] = el)} className="lg:block hidden absolute bottom-40  right-80">
                            <div
                                ...
                                className="bg-[#1a1b1f] absolute w-80 h-46 border border-white
                                 text-white rounded-2xl p-8 flex flex-col justify-between transition hover:scale-105 z-10"
                            >
                               ...
                               <div className="flex">
                                    ...
                                    />
                                    <span className="whitespace-pre-wrap text-8xl font-medium tracking-tighter text-white">+</span>
                                </div>
                            </div>
                            {/* Overlap effect */}
                    ...
                    <div className="w-full lg:w-1/2 space-y-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 pt-6">
                            ...
                            <div
                                ref={(el) => (cardsRef.current[0] = el)}
                                className="bg-[#1a1b1f] border border-white
                                 text-white block lg:hidden w-full max-w-sm h-46  rounded-2xl p-8  justify-between transition hover:scale-105 z-10"
                            >
                            ...
                            <div
                                ...
                                className="w-full max-w-sm h-46 bg-transparent border border-gray-600 text-white rounded-2xl p-8 flex flex-col justify-between transition hover:scale-105 z-10"
                            >
                                <span className="text-2xl font-semibold">Satisfied Customers</span>
                                <div className="flex">
                                    <NumberTicker
                                        value={95}
                                        className="whitespace-pre-wrap text-8xl font-medium tracking-tighter text-white"
                            ...
                            >
                                <span className="text-2xl font-semibold">Smiling clients we served</span>
                                <div className="flex">
                                    <NumberTicker
                                        value={100}
                                        className="whitespace-pre-wrap text-8xl font-medium tracking-tighter text-white"
